  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        <input type='tel' id='number' value={person.number} name='number' onChange={handleChange} placeholder='Enter your Phone Number' disabled={person.id?true:false}  /><br></br><br></br>
        <label htmlFor='email'>Email</label><br></br>
        <input type='email' id='email' value={person.email} name='email' onChange={handleChange} placeholder='Enter your email' disabled={person.id?true:false} /><br></br><br></br>

        <div>
          <div>
            <label>Gender</label><br></br>
            <input type="radio" id="male" name="gender" value="male" onChange={handleChange} checked={person.gender === "male"} disabled={person.id?true:false} />
            <label htmlFor="male">Male</label>
          </div>
          <div>
            <input type="radio" id="female" name="gender" value="female" onChange={handleChange} checked={person.gender === "female"} disabled={person.id?true:false}  />
            <label htmlFor="female">Female</label>
          </div>
          <div>
            <input type="radio" id="other" name="gender" value="other" onChange={handleChange} checked={person.gender === "other"} disabled={person.id?true:false} />
